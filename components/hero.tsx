const Hero = () => {
  return (
    <section className="body-font text-gray-600 dark:text-white">
      ...
      >
        <div className="mb-16 flex flex-col items-center text-center dark:text-white md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
